...
import { BiHomeAlt,BiBuilding, BiServer,BiWalletAlt,BiUser} from "react-icons/bi";
...
const Sidebar = ({ auth }) => {
  ...
  useEffect(() => {
    if (currentOrgID) dispatch(fetchSubscription(currentOrgID));
  }, [currentOrgID]);
  ...
  useEffect(async () => {
    ...
    } else localStorage.setItem("avatar_url", data[0].avatar_url);
  }, []);
        ...
        <SidebarContent>
          <Menu iconShape="square">
            {/* {!sidebarCollapsed && <p className="tag">&nbsp; home</p>} */}
              ...
              <MenuItem  title="Dashboard" icon={<BiHomeAlt/>}>
                Dashboard
                <Link to="/dash/" />
              </MenuItem>
              <MenuItem title="Organisations" icon={<BiBuilding/>}>
                Organisations
            ...
            <SubMenu title="services" icon={<BiServer />}>
            ...
            <SubMenu title="Payments" icon={<BiWalletAlt/>}>
            ...
            <MenuItem title="Profile" icon={<BiUser />}>
              Profile
              <Link to="/dash/profile" />
            </MenuItem>
            <MenuItem title="Settings" icon={<FiSettings />}>
              Settings
